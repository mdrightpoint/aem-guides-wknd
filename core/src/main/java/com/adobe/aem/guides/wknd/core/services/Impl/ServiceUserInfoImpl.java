...
@Component(service = ServiceUserInfo.class, immediate = true)

public class ServiceUserInfoImpl  implements ServiceUserInfo{
    private static final Logger LOG = LoggerFactory.getLogger(ServiceUserInfoImpl.class);
    ...
    String responseString = "null val";

    @Override
    public String addUser(String fname, String lname, String password, String confpassword) throws Exception {
        ...
        try {
            ...
            Resource resource1 = resourceResolver.getResource("/apps/wknd/components/userdata");
            Node nodetemp = resource1.adaptTo(Node.class);
            if(nodetemp.hasNode("mydetails"))
            {
                resource1 = resourceResolver.getResource("/apps/wknd/components/userdata/mydetails");
            }
            else{
